...
public class TestGsonData {
    public static void main(String[] args) {
        ...
        TestBeanDao testBeanDao = daoUtil.getTestBeanDao();
        ...
        List<Map> list = gson.fromJson(jsonData, new TypeToken<List<Object>>(){}.getType());
...
//120.39923258463541,36.11821750217014
        double[] info =   transformBD09ToGCJ02(112.44201,23.6337);
